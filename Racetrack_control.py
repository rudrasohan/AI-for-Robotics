...
############## ONLY ADD / MODIFY CODE BELOW THIS LINE ####################
    ...
    def cte(self, radius):
    	...
    	if (self.x<25.0):
    		#print "CASE1"
    		if flag:
    			cte = (((radius-self.x)**2 + (self.y-radius)**2)**(0.5) - radius)
    		if not flag:
    			cte = (((radius-self.x)**2+(radius-self.y)**2)**(0.5) -radius)

    	elif (self.x>=25.0 and self.x<=75.0):
    		#print "CASE2"
    		if flag:
    		...
    		#print "CASE3"
    		if flag:
    			cte = (((self.x-75.0)**2 + (self.y-radius)**2)**(0.5) - radius)
    		if not flag:
    			cte = (((self.x-75.0)**2 + (radius-self.y)**2)**(0.5) - radius)
